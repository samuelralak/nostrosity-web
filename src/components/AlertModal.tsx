                        ...
                        >
                            <Dialog.Panel
                                ...
                                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                    <button
                                        type="button"
                                        className={`inline-flex w-full justify-center rounded-lg ${alertColor[type].background.normal} px-3 py-2 text-sm font-semibold text-white shadow-sm hover:${alertColor[type].background.light} sm:ml-3 sm:w-auto`}
                                    ...
                                    <button
                                        type="button"
                                        className={`mt-3 inline-flex w-full justify-center rounded-lg bg-white px-3 py-2 text-sm font-semibold text-slate-900 shadow-sm ring-2 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto`}
